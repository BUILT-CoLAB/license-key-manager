...
def queryLogs(requestData):
    adminID = None if int(requestData.get('adminid')) == -1 else int(requestData.get('adminid'))
    dateStart = 0 if int(requestData.get('datestart')) == -1 else int(requestData.get('datestart'))
    dateEnd = sys.maxsize if int(requestData.get('dateend')) == -1 else int(requestData.get('dateend'))
